...
#determine Two Pair
    ...
    if amountOfOne == amountOfTwo == 2 or amountOfOne == amountOfThree == 2 or amountOfOne == amountOfFour == 2 or amountOfOne == amountOfFive == 2 or amountOfOne == amountOfSix == 2 and amountOfFive == 2 or 0 and amountOfSix == 2 or 0 :
